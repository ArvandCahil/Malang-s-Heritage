...
<body>
    <div class="nav-bar">
        <div class="nav-container">
            ...
            <a href="../3. Beranda/Beranda-Guest.html" class="nav-home">Home</a>
            <a href="../2. Login/Login.html" class="nav-login">Login</a>
            <a href="../9. About/About-Guest.php" class="nav-about">About</a>
        </div>
    </div>
    ...
    <div class="container">
        <div class="hasil">
            ...
            <div class="deskripsi">
            <div class="judul-artikel"><a href="../4. Artikel/Candi-Singosari-Guest.php"> Candi Jago: Jejak Kehidupan Raja Wisnuwardhana di Malang, Jawa Timur</a></div>
